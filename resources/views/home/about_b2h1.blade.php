  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="container-md text-center">
        <div class="card m-1">
          <div class="card-header h1">Sobre a Back2Home1</div>
          <div class="container">
          </div>
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-md-5 py-5">
                <img src="assets/img/building/business.jpg" alt="Imagem mostrando a edificação da imobiliária" class="col-md-11">
              </div>
            ...
            <div class="row">
              <h2 class="title-home-1">Miss&atilde;o</h2>
            ...
            <div class="row mt-3">
              <h2 class="title-home-1">Vis&atilde;o</h2>
              <ol>
            ...
            <div class="row my-3">
              <h2 class="title-home-1">Valores</h2>
              ...
              <div class="row g-3 py-3">
                <div class="col-md-6">
                  <h4><strong>Honestidade</strong></h4>
